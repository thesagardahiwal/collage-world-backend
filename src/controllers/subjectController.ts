...
export const createSubject = async (req: Request, res: Response) => {
  try {
    ...
    await subject.save();
    return sendResponse(res, true, 201, 'Subject created successfully', subject);
  } catch (error: any) {
    return sendResponse(res, false, 500, 'Server error', error.message);
  }
};
...
export const getSubjects = async (req: Request, res: Response) => {
  try {
    ...
    return sendResponse(res, true, 200, 'Subjects retrieved successfully', subjects);
  } catch (error: any) {
    return sendResponse(res, false, 500, 'Server error', error.message);
  }
};
...
export const getSubjectById = async (req: Request, res: Response) => {
  try {
    ...
    if (!subject) {
      return sendResponse(res, false, 404, 'Subject not found');
    }
    return sendResponse(res, true, 200, 'Subject retrieved successfully', subject);
  } catch (error: any) {
    return sendResponse(res, false, 500, 'Server error', error.message);
  }
};